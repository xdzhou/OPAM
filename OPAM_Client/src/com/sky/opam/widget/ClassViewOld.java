...
public class ClassViewOld extends View {
	private float delta;
	private float timeW;
	...
	public ClassViewOld(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initia();
	}
	public ClassViewOld(Context context, AttributeSet attrs) {
		super(context, attrs);	
		initia();	
	}
	public ClassViewOld(Context context) {
		super(context);
		initia();
	}
	private void initia(){
